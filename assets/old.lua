...
if p1 then
    ...
    seq = sequence.create(  spawn.create(   EaseInOutExpo.create( rotate_by.create(0.5, pi / 3 ) ),
    ...
    p1:run_action( sequence.create( repeat_times.create( seq, 4 ), call_func.create(function() server:write("yumayo2", "マンメンミ(*´ω｀*)ﾓｷｭ") end), remove_self.create() ) )
